    ...
    <div class="cart_section">
        <div class="container">
                    ...
                    <div class="cart_container">
                        ...
                        <ul class="list-group col-lg-4" style="float: right;">
                            ...
                            <li class="list-group-item">Shiping Charge : <span style="float: right;"> {{ $shipping_charge}}</span> </li>
                                ...
                                @else
                                    <li class="list-group-item">Vat : <span style="float: right;">{{$subtotal}} </span> </li>
                                @endif
                                @if(Session::has('coupon'))
                                    <li class="list-group-item">Total : <span style="float: right;">{{ Session::get('coupon')['balance']*1.1  +$shipping_charge }} đ</span> </li>
                            @else
                                <li class="list-group-item">Total : <span style="float: right;"> {{ $subtotal*1.1 +$shipping_charge  }} đ</span> </li>
                            @endif
            ...
            <div class="cart_buttons">
                ...
                <a href="{{route('cart.showPaymentPage')}}"  class="button cart_button_checkout">Final Step</a>
            </div>
        </div>
    </div>
    </div>
