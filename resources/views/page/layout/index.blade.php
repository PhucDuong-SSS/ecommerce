                    ...
                    <div class="col-12">
                        ...
                        <div class="product-wap d-flex flex-row align-items-start justify-content-between">
                            ...
                            <div class="block-product__menu d-flex flex-row ">
                                <h2 class="block-product__menu-title"><a
                                        href="{{route('product.showProductCategory',['id'=>$category->id])}}">{{$category->name}}</a>
                                </h2>
                                <ul class="d-flex flex-row">
                                    @foreach($category->sub_categories as $subCate)
                                        <li><a class="product-link"
                                               href="{{route('product.showProductSubCategory',['id'=>$subCate->id])}}">{{$subCate->name}}</a>
                                        </li>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="product-grid4">
                                    <div class="product-image4">
                                        ...
                                        <ul class="social">
                                            <li><a href="{{route('product.showDetails',['id'=>$product->id])}}"
                                                   data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                                            {{--                            <li><a  href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>--}}
                                            <li><a class="addcart" data-id="{{$product->id}}" href="#"
