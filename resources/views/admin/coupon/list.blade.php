                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($coupons as $key=>$row)
                            <tr>
                                ...
                                <td>{{ $row->discount }} %</td>
                                <td>
                                    <a href="{{route('coupon.editForm', $row->id)}} " class="btn btn-sm btn-info">Edit</a>
                    ...
                    <form method="post" action="{{ route('coupon.store') }}">
                        ...
                        <div class="modal-body pd-20">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Coupon Code" name="coupon_name">
