        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Admin List
                    <a href="{{route('admin.createUser')}}" class="btn btn-sm btn-warning" style="float: right;">Add New</a>
                </h6>
                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($users as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.showFormEdit', $row->id)}}" class="btn btn-sm btn-info">Edit</a>
                                    <a href="{{route('admin.deleteUser', $row->id)}}" class="btn btn-sm btn-danger">Delete</a>
                                </td>
