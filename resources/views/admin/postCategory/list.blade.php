            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                        @foreach($postCategories as $key=>$row)
                            <tr>
                                <td>{{ $key +1 }}</td>
                                <td>{{ $row->category_name_en }}</td>
                                <td>{{ $row->category_name_vi }}</td>
                                <td>
                                    <a href="{{ route('postcategory.editForm', $row->id) }} " class="btn btn-sm btn-info">Edit</a>
                                    <a href="{{ route('postcategory.delete', $row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                </td>
                ...
                <div class="modal-content tx-size-sm">
                    ...
                    <form method="post" action="{{ route('postcategory.store') }}">
                        ...
                        <div class="modal-body pd-20">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Category Name Vi</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name Hindi" name="category_name_vi">
