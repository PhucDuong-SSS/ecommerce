        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Update Product
                    <a href="{{ route('product.list')}}" class="btn btn-success btn-sm pull-right"> All Product</a>
                </h6>
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_code"  value="{{ $product->code }}">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Quantity: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="product_quantity" value="{{ $product->quantity }}" >
                                </div>
                            </div><!-- col-4 -->
...
{{--                            </div><!-- col-4 -->--}}
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_size" id="size" data-role="tagsinput" value="{{ $product->size }}"  >
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_color" id="color" data-role="tagsinput" value="{{ $product->color }}" >
                                </div>
                            </div><!-- col-4 -->
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <form method="post" action="{{ route('product.updatephoto', $product->id) }} " enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="custom-file">
                                <input type="file" id="" class="custom-file-input" name="image_two" onchange="readURL2(this);"  >
                                <span class="custom-file-control"></span>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <label class="custom-file">
                                <input type="file" id="" class="custom-file-input" name="image_three" onchange="readURL3(this);"  >
                                <span class="custom-file-control"></span>
